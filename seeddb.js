...
let seeddb = async () => {
  ...
  sql =
    "Create Table fac_IndustryConnectDatabase(id varchar(255), Name varchar(255), CompanyName varchar(255), Address text, MobileNumber varchar(255), email varchar(255),OrganizedBy varchar(255), COE varchar(255), description text, filterDate Date)";
  db.query(sql, (err, result) => {
    if (err) throw err;
  ...
  sql =
    "Create Table fac_PhdDetails(id varchar(255), registrationDate Date, defenceDate Date, area varchar(255), university varchar(255), centre varchar(255), guide varchar(255), coguide varchar(255), status varchar(255), COE varchar(255), description text, filterDate Date)";
  db.query(sql, (err, result) => {
    if (err) throw err;
  ...
  sql =
    "Create Table fac_ExchangeProgram(id varchar(255), university varchar(255), program varchar(255), startDate Date, endDate Date, COE varchar(255), description text, filterDate Date)";
  db.query(sql, (err, result) => {
    if (err) throw err;
    console.log("PHD Details Table created successfully");
  });
  ...
  sql =
    "Create Table fac_SponsoredResearchProjects(id varchar(255), sanctionDate Date, grantDate Date, rcid varchar(255),status varchar(255), title varchar(255), proposedAmount varchar(255), durationYear varchar(255), amount varchar(255), objectives text, benefit text, AgencyName varchar(255), received varchar(255), level varchar(255), COE varchar(255), description text, filterDate Date)";
  db.query(sql, (err, result) => {
    if (err) throw err;
  ...
  sql =
    "Create Table fac_VisitorsDatabase(id varchar(255), visitorName varchar(255), number varchar(255), companyName varchar(255), address text, visitDate Date, department varchar(255), description text, filterDate Date)";
  db.query(sql, (err, result) => {
    if (err) throw err;
  ...
  sql =
    "Create Table fac_VVIP(id varchar(255), visitorName varchar(255), number varchar(255), companyName varchar(255), address text, visitDate Date, purpose varchar(255), department varchar(255), description text, filterDate Date)";
  db.query(sql, (err, result) => {
    if (err) throw err;
  ...
  sql =
    "Create Table stu_awards(usn varchar(255), category varchar(255),department varchar(255), filterDate Date, type varchar(255), level varchar(255), eventName varchar(255), awardedBy varchar(255), status varchar(255), date Date, description text, COE varchar(255))";
  db.query(sql, (err, result) => {
    if (err) throw err;
    console.log("Awards Table created successfully");
  });
